...
- [操作步骤](#instructions)
  ...
  - [接受 SSL 证书](#accept-the-ssl-certificate)
  - [授予相机权限](#grant-camera-permissions)
...
所有源代码和文档都可以在 [Live VLM WebUI GitHub 仓库](https://github.com/NVIDIA-AI-IOT/live-vlm-webui) 中找到。
...
<a id="accept-the-ssl-certificate"></a>
### 接受 SSL 证书
...
<a id="grant-camera-permissions"></a>
### 授予相机权限
...
<a id="performance-optimization-tips"></a>
### 性能优化技巧
...
有关更高级的用法，请参阅 GitHub 上的 [完整文档](https://github.com/NVIDIA-AI-IOT/live-vlm-webui/tree/main/docs)。

有关最新的已知问题，请查看 [DGX Spark 用户指南](https://docs.nvidia.com/dgx/dgx-spark/known-issues.html) 和 [Live VLM WebUI 故障排查指南](https://github.com/NVIDIA-AI-IOT/live-vlm-webui/blob/main/docs/troubleshooting.md)。
